...
* **Vulnerability check**: An import for one product and one branch, with one parser and one file name resp. one API configuration is a so-called vulnerability check.

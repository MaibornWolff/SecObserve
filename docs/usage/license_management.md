...
When importing data from CycloneDX SBOMs, the licenses of the components are imported as well, if they are available in the SBOM. The licenses are shown in the `License` tab of the Product view.

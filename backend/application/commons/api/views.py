...
from application.commons.models import Notification, Notification_Read, Settings
from application.commons.queries.notification import (
    get_notification_by_id,
    get_notifications,
)
from application.commons.services.notification import bulk_mark_as_read
...
class NotificationViewSet(
    ...
    def bulk_mark_as_read(self, request):
        ...
        bulk_mark_as_read(request_serializer.validated_data.get("notifications"))
    ...
    def mark_as_read(self, request, pk: int = None):

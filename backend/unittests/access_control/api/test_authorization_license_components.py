...
class TestAuthorizationLicense_Components(TestAuthorizationBase):
    ...
    def _test_authorization_license_components(self):
        ...
        expected_data = "{'id': 1, 'license_data': None, 'purl_namespace': '', 'branch_name': '', 'license_policy_name': '', 'license_policy_id': 0, 'evidences': [{'id': 1, 'name': 'internal_license_evidence_name'}], 'type': 'Unknown', 'title': 'internal license / internal_component:1.0.0', 'identity_hash': '6eef8088480aa2523aeeb64ad35f876a942cc3172cfb36752f3a052a4f88642c', 'upload_filename': '', 'name': 'internal_component', 'version': '1.0.0', 'name_version': 'internal_component:1.0.0', 'purl': '', 'purl_type': '', 'cpe': '', 'dependencies': '', 'license_name': 'internal license', 'license_expression': '', 'unknown_license': 'internal license', 'evaluation_result': 'Allowed', 'numerical_evaluation_result': 1, 'created': '2022-12-15T17:10:35.513000+01:00', 'import_last_seen': '2022-12-15T17:10:35.513000+01:00', 'last_change': '2022-12-15T17:10:35.513000+01:00', 'product': 1, 'branch': None, 'license': None}"
        self._test_api(
            APITest(
                "db_internal_write",
                "get",

...
class TestAuthorizationProducts(TestAuthorizationBase):
    ...
    def _test_authorization_products(self):
        ...
        expected_data = "{'message': 'Cannot delete Product because it still has Services, Observations, License_Components.'}"
        self._test_api(
            APITest(
                "db_internal_write",
                "delete",

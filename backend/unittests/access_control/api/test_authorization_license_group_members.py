...
class TestAuthorizationLicenseGroupMembers(TestAuthorizationBase):
    def test_authorization_license_group_members(self):
        ...
        expected_data = "{'count': 1, 'next': None, 'previous': None, 'results': [{'id': 1002, 'license_group_data': {'id': 1002, 'is_manager': True, 'is_in_license_policy': False, 'name': 'internal_write_manager', 'description': '', 'is_public': False, 'users': [2]}, 'user_data': {'id': 2, 'username': 'db_internal_write', 'first_name': '', 'last_name': '', 'full_name': 'db_internal_write', 'email': '', 'is_active': True, 'is_superuser': False, 'is_external': False, 'setting_theme': 'light', 'setting_list_size': 'medium', 'permissions': [<Permissions.Product_Create: 1104>, <Permissions.Product_Group_Create: 1004>], 'setting_list_properties': '', 'oidc_groups_hash': '', 'is_oidc_user': False, 'date_joined': '2022-12-07T20:24:53+01:00', 'has_password': False}, 'is_manager': True, 'license_group': 1002, 'user': 2}]}"
        self._test_api(
            APITest(
                "db_internal_write",
                "get",
        ...
        expected_data = "{'id': 1004, 'license_group_data': {'id': 1002, 'is_manager': True, 'is_in_license_policy': False, 'name': 'internal_write_manager', 'description': '', 'is_public': False, 'users': [2, 6]}, 'user_data': {'id': 6, 'username': 'db_product_group_user', 'full_name': 'db_product_group_user'}, 'is_manager': False, 'license_group': 1002, 'user': 6}"
        self._test_api(
            APITest(
                "db_internal_write",
                "post",
        ...
        expected_data = "{'id': 1004, 'license_group_data': {'id': 1002, 'is_manager': True, 'is_in_license_policy': False, 'name': 'internal_write_manager', 'description': '', 'is_public': False, 'users': [2, 6]}, 'user_data': {'id': 6, 'username': 'db_product_group_user', 'full_name': 'db_product_group_user'}, 'is_manager': True, 'license_group': 1002, 'user': 6}"
        self._test_api(
            APITest(
                "db_internal_write",
                "patch",

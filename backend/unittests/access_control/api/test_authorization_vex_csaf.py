...
class TestAuthorizationCSAF_Product(TestAuthorizationBase):
    def test_authorization_csaf(self):
        ...
        expected_data = "OrderedDict({'count': 1, 'next': None, 'previous': None, 'results': [OrderedDict({'id': 1, 'name': 'db_branch_internal_dev', 'csaf': 1, 'branch': 1})]})"
        self._test_api(
            APITest(
                "db_internal_write",
                "get",
        ...
        expected_data = "OrderedDict({'count': 1, 'next': None, 'previous': None, 'results': [OrderedDict({'id': 2, 'name': 'CVE_vulnerability_1', 'csaf': 1})]})"
        self._test_api(
            APITest(
                "db_internal_write",
                "get",
...
class TestAuthorizationCSAF_User(TestAuthorizationBase):
    def test_authorization_csaf(self):
        expected_data = "OrderedDict({'count': 1, 'next': None, 'previous': None, 'results': [OrderedDict({'id': 2, 'product_data': None, 'revisions': [], 'vulnerability_names': 'CVE_vulnerability', 'branch_names': 'db_branch_internal_main', 'user_full_name': 'db_external', 'document_id_prefix': 'csaf_prefix', 'document_base_id': '2024_0002', 'version': 1, 'content_hash': 'abcdef123456', 'title': 'csaf_title_vulnerability', 'tlp_label': 'RED', 'tracking_initial_release_date': '2022-12-15T17:10:35.513000+01:00', 'tracking_current_release_date': '2022-12-16T17:13:18.282000+01:00', 'tracking_status': 'final', 'publisher_name': 'publisher name', 'publisher_category': 'publisher category', 'publisher_namespace': 'https://publisher.namespace', 'user': 4, 'product': None})]})"
        self._test_api(
            APITest(
                "db_external", "get", "/api/vex/csaf/", None, 200, expected_data
            )
        )
        ...
        expected_data = "OrderedDict({'count': 1, 'next': None, 'previous': None, 'results': [OrderedDict({'id': 2, 'name': 'db_branch_internal_main', 'csaf': 2, 'branch': 2})]})"
        self._test_api(
            APITest(
                "db_external",
                "get",
        ...
        expected_data = "OrderedDict({'count': 1, 'next': None, 'previous': None, 'results': [OrderedDict({'id': 1, 'name': 'CVE_vulnerability', 'csaf': 2})]})"
        self._test_api(
            APITest(
                "db_external",
                "get",

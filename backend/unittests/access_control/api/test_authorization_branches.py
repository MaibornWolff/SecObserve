...
class TestAuthorizationBranches(TestAuthorizationBase):
    def test_authorization_branches(self):
        ...
        expected_data = "{'id': 1, 'is_default_branch': True, 'open_critical_observation_count': 0, 'open_high_observation_count': 0, 'open_medium_observation_count': 0, 'open_low_observation_count': 0, 'open_none_observation_count': 0, 'open_unkown_observation_count': 0, 'name': 'db_branch_internal_dev', 'last_import': None, 'housekeeping_protect': False, 'product': 1}"
        self._test_api(
            APITest(
                "db_internal_write",
                "get",
        ...
        expected_data = "{'id': 4, 'is_default_branch': False, 'open_critical_observation_count': 0, 'open_high_observation_count': 0, 'open_medium_observation_count': 0, 'open_low_observation_count': 0, 'open_none_observation_count': 0, 'open_unkown_observation_count': 0, 'name': 'string', 'last_import': None, 'housekeeping_protect': False, 'product': 1}"
        self._test_api(
            APITest(
                "db_internal_write",
                "post",
        ...
        expected_data = "{'id': 1, 'is_default_branch': True, 'open_critical_observation_count': 0, 'open_high_observation_count': 0, 'open_medium_observation_count': 0, 'open_low_observation_count': 0, 'open_none_observation_count': 0, 'open_unkown_observation_count': 0, 'name': 'changed', 'last_import': None, 'housekeeping_protect': False, 'product': 1}"
        self._test_api(
            APITest(
                "db_internal_write",
                "patch",

...
class TestAuthorizationCycloneDX_Product(TestAuthorizationBase):
    ...
    def _test_authorization_cyclonedx(self):
        ...
        expected_data = "{'message': 'No CycloneDX matches the given query.'}"
        self._test_api(
            APITest(
                "db_internal_write",
                "get",
        ...
        expected_data = "{'count': 1, 'next': None, 'previous': None, 'results': [{'id': 1, 'name': 'db_branch_internal_dev', 'cyclonedx': 1, 'branch': 1}]}"
        self._test_api(
            APITest(
                "db_internal_write",
                "get",
                "/api/vex/cyclonedx_branches/",
                None,
                200,
                expected_data,
            )
        ...
        expected_data = "{'id': 1, 'name': 'db_branch_internal_dev', 'cyclonedx': 1, 'branch': 1}"
        self._test_api(
            APITest(
                "db_internal_write",
                "get",
                "/api/vex/cyclonedx_branches/1/",
                None,
                200,
                expected_data,
            )
        ...
        expected_data = "{'count': 1, 'next': None, 'previous': None, 'results': [{'id': 2, 'name': 'CVE_vulnerability_1', 'cyclonedx': 1}]}"
        self._test_api(
            APITest(
                "db_internal_write",
                "get",
                "/api/vex/cyclonedx_vulnerabilities/",
                None,
                200,
                expected_data,
            )
        ...
        expected_data = "{'message': 'No CycloneDX_Vulnerability matches the given query.'}"
        self._test_api(
            APITest(
                "db_internal_write",
                "get",
                "/api/vex/cyclonedx_vulnerabilities/1/",
                None,
                404,
                expected_data,
            )
...
class TestAuthorizationCycloneDX_User(TestAuthorizationBase):
    def test_authorization_cyclonedx(self):
        ...
        self._test_api(APITest("db_external", "get", "/api/vex/cyclonedx/", None, 200, expected_data))
        ...
        expected_data = "{'count': 1, 'next': None, 'previous': None, 'results': [{'id': 2, 'name': 'db_branch_internal_main', 'cyclonedx': 2, 'branch': 2}]}"
        self._test_api(
            APITest(
                "db_external",
                "get",
        ...
        expected_data = "{'message': 'No CycloneDX_Branch matches the given query.'}"
        self._test_api(
            APITest(
                "db_external",
                "get",
        ...
        expected_data = "{'count': 1, 'next': None, 'previous': None, 'results': [{'id': 1, 'name': 'CVE_vulnerability', 'cyclonedx': 2}]}"
        self._test_api(
            APITest(
                "db_external",
                "get",
        ...
        expected_data = "{'id': 1, 'name': 'CVE_vulnerability', 'cyclonedx': 2}"
        self._test_api(
            APITest(
                "db_external",
                "get",

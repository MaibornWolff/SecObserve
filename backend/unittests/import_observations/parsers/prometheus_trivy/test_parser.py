...
from application.import_observations.parsers.prometheus_trivy.parser import PrometheusTrivy


class TestPrometheusTrivyParser(TestCase):
    def test_no_json(self):
        with open(path.dirname(__file__) + "/test_parser.py") as testfile:
            parser = PrometheusTrivy()

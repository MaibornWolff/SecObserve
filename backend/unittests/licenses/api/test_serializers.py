...
from application.licenses.models import License_Group_Member, License_Group, License_Policy, License_Policy_Member, License
...
class TestLicensePolicyMemberSerializer(BaseTestCase):
    def setUp(self) -> None:
        ...
        self.license_policy_member_1 = License_Policy_Member(license_policy=self.license_policy_1, user=self.user_internal)

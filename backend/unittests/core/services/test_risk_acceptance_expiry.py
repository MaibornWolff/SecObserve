...
from application.core.services.risk_acceptance_expiry import calculate_risk_acceptance_expiry_date
...
class TestCalculateRiskAcceptanceExpiryDate(BaseTestCase):
    ...
    def test_product_group_risk_acceptance_expiry_active_is_true_and_days_is_positive(self):
        product = Product(risk_acceptance_expiry_active=None)

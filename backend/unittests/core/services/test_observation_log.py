...
class TestObservationLog(BaseTestCase):
    ...
    def test_create_observation_log(
        ...
        observation_log = create_observation_log(
            self.observation_1, "severity", "status", "comment", "vex_justification", Assessment_Status.ASSESSMENT_STATUS_AUTO_APPROVED
        )
        ...
        self.assertEqual(Assessment_Status.ASSESSMENT_STATUS_AUTO_APPROVED, observation_log.assessment_status)

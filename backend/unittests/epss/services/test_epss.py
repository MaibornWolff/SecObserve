...
class TestEPSS(BaseTestCase):
    ...
    def test_epss_apply_observation_not_cve(self, mock_observation_save, mock_epss_score):
    ...
    @patch("application.core.models.Observation.save")
    def test_epss_apply_observation_no_epss(self, mock_observation_save, mock_epss_score):
    ...
    @patch("application.epss.models.EPSS_Score.objects.get")
    @patch("application.core.models.Observation.save")
    def test_epss_apply_observation_cve_different(self, mock_observation_save, mock_epss_score_get):
    ...
    @patch("application.epss.models.EPSS_Score.objects.get")
    @patch("application.core.models.Observation.save")
    def test_epss_apply_observation_cve_same(self, mock_observation_save, mock_epss_score_get):

...
![Version: 1.0.0](https://img.shields.io/badge/Version-1.0.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.39.2](https://img.shields.io/badge/AppVersion-1.39.2-informational?style=flat-square)
...
| backend.image.tag | string | `"1.39.2"` |  |
...
| frontend.image.tag | string | `"1.39.2"` |  |
